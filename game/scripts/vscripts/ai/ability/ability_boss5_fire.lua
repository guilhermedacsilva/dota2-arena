...
function ThinkSpirits( event )
    ...
    if ability.spirits_numSpirits < idealNumSpiritsSpawned then
        ...
        -- Spawn a new spirit
        local newSpirit = CreateUnitByName( "npc_boss_unit_5_lava", casterOrigin, false, caster, caster, caster:GetTeam() )
    ...
    --
    local currentRotationAngle  = 45 + elapsedTime * event.spirit_turn_rate
